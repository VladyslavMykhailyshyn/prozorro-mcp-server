...
## Приклади викликів інструменту

Приклади аргументів `search_tenders` для типових запитів.

**Знайти всі тендери конкретної організації:**
```json
{
  "EDRPOUCode": "21560045"
}
...
**Знайти тендери за назвою організації в межах діапазону дат:**
```json
{
  "legalName": "Укрпошта",
  "dateFrom": "2025-01-01",
...
**Знайти найбільші тендери за сумою:**
```json
{
  "legalName": "Укрпошта",
  "sortBy": "amount_desc",
...
**Знайти найновіші оновлені тендери:**
```json
{
...
**Знайти фізичну особу-підприємця (ФОП) як учасника/постачальника:**
```json
{
...
**Перегляд наступної сторінки великого набору результатів (друга сторінка, по 100 записів):**
```json
{
  "legalName": "Укрпошта",
  "sortBy": "amount_desc",
...
**Отримати справжню загальну кількість збігів, а не лише кількість на поточній сторінці:**
```json
{
  "legalName": "Укрпошта",
  "includeTotal": true
...
```
Відповідь міститиме `"total_count": 4832` поряд з `"count"` (кількість записів на цій сторінці) та `"data"`.
